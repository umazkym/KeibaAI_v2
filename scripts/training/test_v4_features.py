...
def main():
    ...
    logger.info("=" * 70)
    logger.info("V4特徴量エンジニアテスト（リーク修正版）")
    logger.info("=" * 70)
    ...
    logger.info(f"Gap:   1ヶ月")
    
    # V4特徴量エンジニア
    from keibaai.src.features.leak_free_feature_engineer_v4 import LeakFreeFeatureEngineerV4
    
    logger.info("\nV4 fit...")
    fe = LeakFreeFeatureEngineerV4()
    fe.fit(
        races_df=train_df,
