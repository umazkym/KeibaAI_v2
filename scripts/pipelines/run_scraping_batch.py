...
使用方法:
    ...
    python scripts/pipelines/run_scraping_batch.py --from 2020-01-01 --to 2024-12-31 --batch-size 100

    # カスタムバッチサイズ（200日ごと）
    python scripts/pipelines/run_scraping_batch.py --from 2020-01-01 --to 2024-12-31 --batch-size 200
