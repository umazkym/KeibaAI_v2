...
使用例:
  ...
  # バリデーションのみ実行
  python scripts/maintenance/run_quality_checks.py --config keibaai/configs/default.yaml --validation-only
  ...
  # 定期実行用（cron対応）
  0 3 * * * cd /path/to/KeibaAI_v2 && python scripts/maintenance/run_quality_checks.py --config keibaai/configs/default.yaml
        """
    )
