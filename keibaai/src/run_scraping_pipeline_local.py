...
def main():
    ...
    try:
        ...
        # 日付範囲の設定（設定ファイルまたはコマンドライン引数から）
        # TODO: コマンドライン引数対応
        from_date = "2023-01-01"
        to_date = "2023-01-31"
        
        kaisai_dates = _scrape_html.scrape_kaisai_date(from_date, to_date)
    ...
    log.info("スクレイピングパイプライン（.bin形式）が終了しました")
