...
│   │   └── run_quality_checks.py  # 品質チェック統合実行
│   └── notebooks/              # Jupyter Notebook
├── docs/                       # ドキュメント
│   ├── system/                 # システムドキュメント（本ファイル）
│   └── QUALITY_CHECK_GUIDE.md  # 品質チェックガイド
├── debug_*.py                  # デバッグスクリプト（20+個）
...
**場所**: `keibaai/scripts/run_quality_checks.py`
