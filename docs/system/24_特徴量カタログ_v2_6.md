...
## 10. V16新特徴量 (V16 New Features) 【2026-01-13更新】
...
| `prev_finish_cat` | 前走着順カテゴリ | - | 整数版（0=top3, 1=mid, 2=bottom） |
| **`jw_rank_in_race`** | **JW相対化（レース内順位）** | **複勝+3.1%** | **2026-01新規 ★★★★☆** |
| **`team_power`** | **チーム力（JW+TW平均）** | **補助** | **2026-01新規 ★★★☆☆** |

### jw_rank_in_race / team_power 検証結果【2026-01-16更新】
...
---
**合計特徴量数**: 約 75個（V16: 73 + jw_rank_in_race + team_power）
**除外しているデータ**:
